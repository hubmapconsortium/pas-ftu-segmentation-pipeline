...
from utils_data_generation import HuBMAPDatasetExternal, generate_data, my_collate_fn
...
if __name__ == "__main__":
    ...
    pseudo_df = (
        pseudo_df[["filename", "predicted"]]
        .copy()
        .rename(columns={"filename": "id", "predicted": "encoding"})
    )
